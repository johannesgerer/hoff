...
te4     = unsafeH $ execRecAggBy ANON_F { a = sumA @Int64 #b, b = mapA (count @(Vector Int64)) #b } (#c :: Exp I Char) ta
te5     = unsafeH $ execRecAggBy ANON_F { a = sumA @Int64 #b, b = countA } (co 'a') ta
te6     = unsafeH $ execAggBy (zip_ (sumA @Int64 #b) $ mapA @Int64 count #b) (co 'a') ta
te8     = unsafeH $ execRecAggBy ANON_F { a = sumA @Int64 #b, b = countDistinct #e, c = countDistinct #c } (co 'a') ta
