...
let pkgs = pkgs2;
    ...
    source-overrides = {
      ...
      ghc-tcplugin-api = "0.10.0.0"; # needed for typelet 0.1.3
    ...
    overrides = self: super: let
      ...
      # large-anon-drv = self.callHackage "large-anon" "0.3.0" {};
      large-anon-drv = super.large-anon;
    in {
      yahp    = minSource "yahp";
      ...
      large-anon        = enableCabalFlag "disableFourmoluExec" 
